...
describe("cherrypie", function () {
  describe("#populate()", function () {
    describe('`__namespace` directive --> respect namespacing when populating the model', function () {
    ...
    describe('`__children` directive --> child model description', function () {
    ...
    describe('`__transferKeys` directive --> take all available keys and pass them "as is"', function () {
    ...
    describe('`__ignoredKeys` directive --> skip ignored keys when creating the model', function () {
      ...
      it('Should skip but not remove the __ignoredKeys from the origin data so that they are available in the computed properties',
          function () {
            var origin = {
              session: {
                sessionName: "Authentication",
                sessionId: 2016,
                someCrudeProperty: ['really crude things happen to me', 'I am batman!'],
                detail: {
                  actions: [{
                    actionId: 1,
                    name: "login",
            ...
            var modelDescription = {
              __namespace: 'session',
              __transferKeys: true,
              __ignoredKeys: ['someCrudeProperty'],
              name: 'sessionName',
              actions: 'detail.actions',
              description: function computedDescription (originData) {
                return originData.someCrudeProperty[1];
              },
              __children: {
                actions: {
                  __transferKeys: true,
  ...
  describe("#desolate()", function () {
    describe('`__serializable` directive --> serialize the cherrypie rich-model', function () {
